...
What you see is a line of code followed by a line of output (starting with "[1]")

## Creating an object

We can save it into an object using the assignment operator `<-`
...
# 8 * 4 This is also just a comment
2 * 3
```
