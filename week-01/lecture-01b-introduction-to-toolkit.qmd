---
title: "Data 200: Lecture 01a"
subtitle: "Introduction to our toolkit"
...
If writing a long line of code you can break it up across multiple lines (make sure to indent!)

```{r eval = FALSE}
apple_data <- data.frame(apple_colors = c("green", "yellow", "red"), apple_count = c(3, 17, 8))
# versus
apple_data <- data.frame(
  apple_colors = c("green", "yellow", "red"), 
  apple_count = c(3, 17, 8)
...
Slides that you are currently looking at are also written in Quarto. You can take a look at them on in the [GitHub repository](https://github.com/csuci-data200/lectures) I use to make the slides.
...
In order to use a package you have to:
