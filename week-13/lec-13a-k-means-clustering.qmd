...
**K-means clustering** is an unsupervised machine learning method to partition $n$ observations into $k$ clusters/groups, where each observation belongs to the cluster with the nearest mean
