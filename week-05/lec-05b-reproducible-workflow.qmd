...
It is also a good practice to save session information as package versions change, in order to be able to 

- reproduce results from an analysis we need to know under what technical conditions the analysis was conducted,
- figure out [bugs in packages](https://github.com/quarto-dev/quarto/issues/791)
