...
subtitle: "Data visualization improvements and other data representations"
...
ggplot(penguins, aes(x = bill_depth_mm,y = bill_length_mm, color = species)) +
  ...
  labs(
    ...
    caption = "Relationship between bill depth (mm) and length (mm) for different species of penguins"
  )
```
